...
let client = redis.createClient ('redis://:J11Bk6uwsVmKS4gE6ElGZoYhufFjj6ti@redis-14483.c8.us-east-1-3.ec2.cloud.redislabs.com:14483');
...
let getAllUsersInHash = (hashName, callback)=>{
    ...
    client.HGETALL(hashName, (err, result)=>{
        if(err){
          ...
          logger.info('Online users list is empty.','redisLib: getAllUsersInHash()',7);
          callback(null,{});
        }else{

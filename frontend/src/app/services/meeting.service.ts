...
export class MeetingService {
  ...
  public getMeeting(meetingId, authToken): Observable<any> {
    return this.http.get(
      `${this.baseUrl}/meetings/details/${meetingId}?authToken=${authToken}`
    );
  }
  ...
  public deleteMeeting(authToken, meetingId): Observable<any> {
    ...
    return this.http.post(`${this.baseUrl}/meetings/delete`, params);
  }

  public getAllMeetingsOfUser(authToken, userId): Observable<any> {
    return this.http.get(
      `${this.baseUrl}/meetings/view/all/${userId}?authToken=${authToken}`
    );
  }
